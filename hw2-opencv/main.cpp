...
constexpr double MY_PI = 3.1415926;//定义了Π值
...
Eigen::Matrix4f get_model_matrix(float rotation_angle)//模型变换
{
    Eigen::Matrix4f model = Eigen::Matrix4f::Identity();
    return model;
}

Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)//投影变换
{
...
int main(int argc, const char** argv)
{
    ...
    rst::rasterizer r(700, 700);//初始化rasrerizer类
